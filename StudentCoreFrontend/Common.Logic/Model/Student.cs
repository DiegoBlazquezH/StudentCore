...
namespace Common.Logic.Model
{
    public class Student
    {
        ...
        public Student() => GUID = Guid.NewGuid();

        public Student(Guid gUID, int iD, string name, string surname, string dNI, DateTime birthDate, int age, DateTime registerDate)
        {
            GUID = gUID;
            ID = iD;
            Name = name;
        ...
        public Student(int iD, string name, string surname, string dNI, DateTime birthDate, int age, DateTime registerDate)
        {
            GUID = Guid.NewGuid();
            ID = iD;
            Name = name;
        ...
        public Student(int iD, string name, string surname, string dNI, DateTime birthDate)
        {
            ID = iD;
            Name = name;
            Surname = surname;
